...
const UI = (function() {
    ...
    const elements = {
		...
		guestNavDriverLicense: document.getElementById('guestNavDriverLicense'),
		navTsu: document.getElementById('navTsu'),
    ...
    const templates = {
		...
		guestDriverLicense: document.getElementById('guestDriverLicenseTemplate')?.content,
		tsuList: document.getElementById('tsuListTemplate')?.content,
		tsuForm: document.getElementById('tsuFormTemplate')?.content,
